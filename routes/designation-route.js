...
async function createDesignation(req, res) {
    ...
    try {
        ...
        if (validationResponse != true) {
            ...
            responseEntries.data = await designationServices.createDesignation(req.body);
            if (!responseEntries.data) responseEntries.message = messages.DATA_NOT_FOUND;
        }
    } catch (error) {
        responseEntries.error = true;
...
async function updateDesignation(req, res) {
    ...
    try {
        ...
        if (validationResponse != true) {
            ...
            responseEntries.data = await designationServices.updateDesignation(req.params.designationId, req.body);
            if (!responseEntries.data) responseEntries.message = messages.DATA_NOT_FOUND;
        }
    } catch (error) {
        responseEntries.error = true;
