  ...
  try {
    ...
    const result = await sequelize.query(
      `SELECT l.loan_id "loanId",a.applicant_code "applicantCode",a.contact_no "contactNo" ,
        ...
        l.loan_status_id "loanStatusId",ls.status_name "loanStatusName",
        ...
        left join status_lists ls on ls.status_list_id = l.loan_status_id ${iql} `,
      {
...
async function getLoanDetails(query) {
  try {
    ...
    const result = await sequelize.query(
      ...
      l.disbursed_method_id "disbursedMethodId",dm.status_name "disbursedMethodName",
      ...
      left join status_lists dm on dm.status_list_id = l.disbursed_method_id 
